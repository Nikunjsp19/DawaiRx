...
**Important:** Use the same MongoDB URI and database name as your existing deployment so existing users can log in.
...
Admins are identified by the **MongoDB `admins` collection**:

...
/** Upload ordered files + sold file (and optional mapping). Optional dateFrom, dateTo, reportName for backend date filtering (Java single-request upload+run). Returns { success, session_id } or { run_id } for use with runReport. */
export async function uploadReportFiles(orderedFiles, soldFile, mappingFile = null, dateFrom = null, dateTo = null, reportName = null) {
  const form = new FormData()
